package com.yghee.book.springboot.config.auth.dto;

import com.yghee.book.springboot.domain.user.Role;
...
public class OAuthAttributes {
    ...
    //  2 User 엔티티를 생성 OAuthAttributes에서 엔티티를 생성하는 시점은 처음 가입할 때
